...
precision mediump float;
    ...
    uniform float speed13;
    uniform float frequency14;
    uniform float sync15;
...
void main () {
  ...
  gl_FragColor = src(rotate(modulate(st, osc(st, frequency14, sync15, offset16), amount18), angle12, speed13), tex11);
}
