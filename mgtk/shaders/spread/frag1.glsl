...
precision mediump float;
    ...
    uniform float xMult21;
    uniform float yMult22;
    uniform float scale23;
    uniform float offset24;
    uniform float scale25;
    uniform float offset26;
    uniform float amount28;
    uniform float amount30;
    uniform float angle31;
    uniform float speed32;
    uniform float r33;
    uniform float g34;
    uniform float b35;
    uniform float a36;
    uniform float amount38;
uniform float time;
...
void main () {
  ...
  gl_FragColor = mult(src(scale(modulate(rotate(st, angle31, speed32), add(noise(rotate(st, angle31, speed32), scale23, offset24), noise(rotate(st, angle31, speed32), scale25, offset26), amount28), amount30), amount20, xMult21, yMult22), tex19), solid(st, r33, g34, b35, a36), amount38);
}
