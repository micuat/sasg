...
precision mediump float;
    ...
    uniform float amount7;
    uniform float amount9;
...
void main () {
  ...
  gl_FragColor = add(color(mult(shape(scale(st, amount10, xMult11, yMult12), sides1, radius2, smoothing3), colorama(osc(scale(st, amount10, xMult11, yMult12), frequency4, sync5, offset6), amount7), amount9), r13, g14, b15), src(st, tex17), amount18);
  // vec2 st = vertTexCoord.st;
  // gl_FragColor = osc(st, frequency4, sync5, offset6);
}
