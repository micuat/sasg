...
precision mediump float;
    ...
    uniform float nSides4;
    uniform float nSides5;
    uniform float amount6;
    uniform float scale7;
    uniform float offset8;
    uniform float threshold9;
    uniform float tolerance10;
    uniform float amount12;
    uniform float pixelX13;
    uniform float pixelY14;
    uniform float r15;
    uniform float g16;
    uniform float b17;
    uniform sampler2D tex19;
    uniform float amount20;
    uniform float amount21;
    uniform float amount22;
    uniform float xMult23;
    uniform float yMult24;
uniform float time;
...
void main () {
  ...
  gl_FragColor = colorama(blend(color(add(contrast(osc(kaleid(kaleid(pixelate(scale(st, amount22, xMult23, yMult24), pixelX13, pixelY14), nSides5), nSides4), frequency1, sync2, offset3), amount6), thresh(noise(pixelate(scale(st, amount22, xMult23, yMult24), pixelX13, pixelY14), scale7, offset8), threshold9, tolerance10), amount12), r15, g16, b17), src(scale(st, amount22, xMult23, yMult24), tex19), amount20), amount21);
}
